...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        public void AddComment(string comment, string username)
        {
            if (!_active)
            {
                throw new InvalidOperationException("You cannot comment to an inactive post!");
            }
        ...
        public void EditComment(Guid commentId, string comment, string username)
        {
            ...
            {
                throw new InvalidOperationException("You not allowed to edit a comment that was made by another user!");
            }
        ...
        public void RemoveComment(Guid commentId, string username)
        {
            ...
            if (!_comments[commentId].Item2.Equals(username, StringComparison.CurrentCultureIgnoreCase))
            {
                throw new InvalidOperationException("You not allowed to remove a comment that was made by another user!");
            }
