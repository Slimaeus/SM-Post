...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class EditCommentController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> EditMessageAsync(Guid id, EditCommentCommand command)
        {
            try
            {
                command.Id = id;
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Error while processing request to edit the comment of a post!";
